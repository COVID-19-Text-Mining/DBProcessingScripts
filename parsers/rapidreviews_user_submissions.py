...
class RapidReviewsDocument(VespaDocument):
    ...
    unparsed_document = ReferenceField('UnparsedRapidReviewDocument', required=True)

class RapidReviewsParser(Parser):

    def __init__(self, parse_full_text=False):
        """
        Parser for documents uploaded by RapidReviews: COVID-19 volunteers and editors.
        """
    ...
    def _parse_origin(self, doc):
        ...
        name for this."""
        return "rapidreview_submissions"
    ...
    def _parse_source_display(self, doc):
        ...
        return doc.get("source_display", doc['journal'])
    ...
    def _parse_has_full_text(self, doc):
        ...
        return doc.get("has_full_text", False)
    ...
    def _parse_body_text(self, doc):
        ...
        if self.parse_full_text:
            paper_fs = gridfs.GridFS(self.db, collection='rapidreview_submissions_fs')
    ...
    def _parse_document_type(self, doc):
        ...
        return doc.get("document_type", "paper")
...
class UnparsedRapidReviewDocument(DynamicDocument):
    ...
    parsed_class = RapidReviewsDocument

    parsed_document = ReferenceField(RapidReviewsDocument, required=False)
    ...
    def parse(self):
        ...
        return RapidReviewsDocument(**parsed_document)